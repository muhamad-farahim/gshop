...
class RentVariantManager
{
    ...
    static function create_and_save($asoc)
    {
        ...
        $sql = "INSERT INTO product_rent_variant VALUES (NULL, '$img', '$name', $product_fk);";
    ...
    static function get_variant_by_product($prodid)
    {
        ...
        $sql = "SELECT * FROM product_rent_variant WHERE product_fk = $prodid";
        $q = mysqli_query($CONNECTION, $sql);
