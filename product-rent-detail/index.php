    ...
    <div class="container pdetaill my-5">
            ...
            <div class="col-12 col-lg-5">
                <div class=" pdetaill__detail-price card justify-content-center align-items-center">
                    <div class="card-body justify-content-center text-center">
                        <div class="card-title"><h2>Camera Cannon 5 PRO</h2></div>
                        <div class="card-title"><h2 class="pdetaill__cardprice">12.000/Day</h2></div>
        ...
        <div class="card pdetaill__desc p-3 px-5 pb-3">
            <div class="card-body">
                ...
                <div class="card-text">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptate pariatur est maxime vero iure? Quisquam, qui officia necessitatibus voluptatum explicabo aspernatur quasi. Quam, cupiditate facere, sapiente nisi quod animi facilis soluta dignissimos nulla provident eius architecto ab quidem, vitae ut magnam magni pariatur quos neque eaque assumenda eos quis? Accusamus distinctio expedita, aliquam tempora dolorum id alias assumenda dolore soluta porro fugit possimus, ipsum hic? Ipsa delectus veritatis quas ipsam deleniti vero rerum odio necessitatibus modi ab quidem facilis, enim blanditiis nostrum nobis rem dignissimos aut et exercitationem molestias ducimus reprehenderit nisi. Aliquam facere quaerat nesciunt sequi deserunt sit quae quis eum incidunt, necessitatibus consectetur asperiores, culpa facilis? Recusandae perspiciatis quasi voluptatem beatae laudantium molestias magni quam doloribus iste impedit, reprehenderit eum hic fugiat voluptates quibusdam magnam illum, totam laboriosam, cumque suscipit! Ipsam accusamus officiis quae numquam ipsa nisi dolore perspiciatis accusantium molestiae eaque, ex, eius quidem asperiores libero cupiditate! 


                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero ad, facilis minima ratione voluptatem beatae neque iure nihil iusto quas non molestias animi debitis id explicabo architecto. Pariatur tempore nulla dicta laborum distinctio, consequuntur, delectus eum dolorem officia qui earum fugiat molestiae. Consequuntur hic harum dolorum cum distinctio necessitatibus ut voluptate vero molestias, optio facere dolor beatae excepturi quas minima fugit quasi aperiam ipsum. Non mollitia sit perferendis, dolorem magni atque iure distinctio ipsam hic numquam, illo fuga saepe est sunt sapiente. Iste mollitia maiores at alias pariatur libero eos nobis porro, dolor tenetur, explicabo culpa inventore ipsam! Delectus minus molestias exercitationem quis repellendus, illo quos molestiae dolores possimus alias ea tempore, libero nostrum omnis! Cumque molestiae inventore deleniti ea rem recusandae officia. Nihil optio perferendis, quam accusamus velit ducimus, suscipit ut dolore et provident, voluptatem qui earum quis quasi obcaecati delectus. Maiores aut eligendi eveniet, rem sunt quod repudiandae.
                </div>
                <div class="hr2"></div>
