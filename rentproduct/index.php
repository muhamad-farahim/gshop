...
<body>
    ...
    <div class="productss">
        ...
        <div class="container p-0">
            <h1 class="text-center my-5">RENT PRODUCTS</h1>
            ...
            <div class="row gx-2 gy-4 mt-5 productss__grid">
                ...
                $rentarr = ProductRentManager::get_all();

                foreach ($rentarr as $pr) {
                            ...
                            <div class="card productsscard">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="productsscard__maincard py-2">
                                        ...
                                        <p class="my-2"><?php echo $pr->name; ?></p>


                                        <p class="m-0">
                                        <p class="m-0">
                                            <strong><?php echo 'Rp' . number_format($pr->priceperday, 2,  ',', '.') ?></strong>
                                        </p>
                                        </p>
                                    ...
                                    <div class="card-text productsscard__misc">
                                        <div class="productsscard__element">
                                            ...
                                            <p class="productsscard__usertext my-0"><?php echo $pr->get_user_name() ?></p>
                                        </div>
                                        ...
                                        <div class="productsscard__stock mt-2">
                                            <p class="text-center mb-2"><?php echo $pr->stock; ?> stocks left</p>
                                            <!-- <div class="progress">
